            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="admin/update.html" method="post" role="form">
                        ...
                        <p style="color: #aa0000" align="center">${requestScope.exception.message}</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="userName" value="${requestScope.admin.userName}" class="form-control" id="exampleInputPassword1" placeholder="请输入用户昵称">
                        </div>
                        <div class="form-group">
